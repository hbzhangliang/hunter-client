      ...
      <div class="main">
        ...
        <div class="tableBox">
          <div class="pageTableContent">
            <el-button type="primary" class="addBanner" @click="addAcl"><i class="el-icon-plus"></i>新增权限</el-button>
        ...
        <!--弹出框-->
        <el-dialog custom-class="info" title="管理权限信息" :visible.sync="moduleVisible" size="tiny"
                   @close="closeDialog">
...
<script>
  ...
  import {aclList,getAcl,saveAcl,delAcl} from '@/api/api'
  import $ from 'jquery'
  export default{
    data () {
      return {
    ...
    methods: {
      init(page,pageSize){
        ...
        aclList({"page":page,"pageSize":pageSize}).then(res => {
