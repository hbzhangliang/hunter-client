...
<script>
    ...
    import {talentGetVo,talentGet,talentListPage,talentListAll,talentAdminDel,talentSave,
    ...
    export default {
        ...
        methods: {
            ...
            init(page,pageSize){
                ...
                talentListPage(_this.pageParams).then(res => {
                    res.data.forEach(p => {
            ...
            delBatch(){
                ...
                this.$confirm('此操作将永久删除该人才数据, 是否继续?', '提示', {
                    ...
                    talentAdminDel({ids:_this.multipleSelection}).then(p=>{
                        _this.$message({
                            message: '永久删除人才数据成功',
                            type: 'success'
                        });
