...
<script>
    ...
    import {talentGetVo,talentGet,vtalentDocList,talentListAll,talentDel,talentSave,
    ...
    export default {
        ...
        methods: {
            ...
            init(page,pageSize){
                var docId=parseInt(this.$store.state.editableTabsValue.substring(10))
                this.pageParams.params.eq_docId=docId

                console.log("init"+docId)
                var _this=this;
                _this.loading=true;
                _this.pageParams.page=page;
                _this.pageParams.pageSize=pageSize;
                vtalentDocList(_this.pageParams).then(res => {
                    res.data.forEach(p => {
