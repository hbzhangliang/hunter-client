...
<script>
    import {companyGetVo,companyGet,companyList,companyListPage,companyListAll,companyDel,companyAdminDel,companySave,companyShareList,
    ...
    export default {
        ...
        methods:{
            ...
            init(page,pageSize){
                ...
                companyShareList(_this.pageParams).then(res => {
                    res.data.forEach(p => {
