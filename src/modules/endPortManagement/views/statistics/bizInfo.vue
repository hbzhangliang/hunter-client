    ...
    <div class="content" style="height: 780px;">
      ...
      <div>
        <el-table
          ...
          style="width: 98%;height: 200px;overflow-y: auto;">
          <el-table-column  :prop="item.prop"  :label="item.label" v-for="item in colsList" :key="item" v-loading="isBusy" >
          </el-table-column>
        </el-table>
      </div>
...
<script>
  ...
  import { bizInfoSts } from '@/api/api'
  import $ from 'jquery'
